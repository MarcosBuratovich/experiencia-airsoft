...
insert into public.bot_conocimiento (titulo, contenido, orden) values
  ('¿Duele?', 'Pica, no duele. Se juega con ropa larga y protección obligatoria en la cara. La mayoría se sorprende de lo poco que es.', 0),
  ('Qué llevar', 'Ropa larga que se pueda ensuciar, zapatillas o borcegos cómodos y ganas. El resto lo ponemos nosotros.', 1),
  ('Edad mínima', 'Desde los 18 años, sin excepciones. Pedimos DNI a todos en el ingreso. Es normativa, no una política nuestra: las marcadoras requieren mayoría de edad.', 2),
  ('Cómo llegar y estacionamiento', 'Hay estacionamiento propio y gratuito en el predio.', 3),
  ('Si llueve', 'Se juega igual salvo tormenta fuerte. Si hay que suspender avisamos por Instagram y se reprograma.', 4),
  ('Cuánto dura', 'Una jornada dura alrededor de 4 horas, con descansos entre partidas.', 5),
  ('Medios de pago', 'Efectivo o transferencia. Los precios son distintos según el medio.', 6)
